...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2021 at 08:18 AM
...
INSERT INTO `mst_items` (`id`, `item_name`, `item_no`, `chapter_name`, `item_description`, `is_active`, `created_on`, `updated_on`) VALUES
(1, 'UKSR', 1, 'XYZ', 'Earth work excavation in ordinary soil exclusive of compensation of earth. :\r\nKassi  work  undressed  involving  n  average  horizontal throw upto 2 metres, and an average vertical lift upto 0.05 metre including breaking of clods.', 'Y', '2021-03-25 11:13:49', '2021-03-25 11:13:49'),
(2, 'UKSR', 2, 'XYZ', 'Earth work excavation in ordinary soil exclusive of compensation of earth. :\r\nearth-work  undressed  with  a  combined  lead  upto  15 metres including breaking of clods', 'Y', '2021-03-25 11:13:49', '2021-03-25 11:13:49'),
(3, 'DSR', 4, 'ABC', 'Providing and fixing dry cladding upto 10 metre heights with 30mm thick gang saw cut stone with (machine cut edges) of uniform colour and size upto 1mx1m, fixed to structural steel frame work and/ or with the help of cramps, pins etc. and sealing the joints with approved weather sealant as per Architectural drawing and direction of Engineer-in-charge. (The steel frame work, stainless steel cramps and pins etc. shall be paid for separately).: Red sand stone - 30mm thick gang saw cut stone', 'Y', '2021-03-27 16:34:48', '2021-03-27 16:34:48'),
(4, 'DSR', 5, 'ABC', 'Providing and fixing structural steel frame (for dry cladding with 30 mm thick gang saw cut with machine cut edges sand stone) on walls at all heights using M.S. square/ rectangular tube in the required pattern as per architectural drawing, including cost of cutting, bending, welding etc. The frame work shall be fixed to the wall with the help of M.S. brackets/ lugs of angle iron/ flats etc. which shall be welded to the frame and embedded in brick wall with cement concrete block 1:2:4 (1 cement ', 'Y', '2021-03-27 16:34:48', '2021-03-27 16:34:48'),
(5, 'DSR', 6, 'ABC', 'providing and fixing 38 mm thick wood block flooring of first class teak wood laid over 25 mm thick leveling layer of cement concrete 1:2:4 (1 cement : 2 coarse sand : 4 graded stone aggregate 10 mm nominal size) to be paid separately, coated with a thin layer of hot bitumen penetration 80/25 (blown type) @ 2.45 kg per sqm, including fixing blocks in position after dipping in hot bitumen (blown type) up to half depth, planed, levelled smooth and finished complete.', 'Y', '2021-03-27 16:34:48', '2021-03-27 16:34:48');
...
(6, 0, 1, 2, 3, '8000000.00', 'Sa', '', 'Y', '2021-03-25 19:21:20', '2021-03-25 19:21:20');
...
(2, NULL, 2, 1, '20000.00', 'Auto', '2', 1, '', '2021-03-25 10:04:42', '2021-03-25 10:04:42'),
(4, NULL, 5, 1, '10000.00', 'Auto', '', 0, '', '2021-03-25 19:04:28', '2021-03-25 19:04:28'),
(5, NULL, 2, 1, '0.00', 'On Demand', '', 0, '', '2021-03-25 19:07:10', '2021-03-25 19:07:10'),
(6, NULL, 2, 1, '500.00', 'On Demand', '', 0, '', '2021-03-25 19:11:20', '2021-03-25 19:11:20'),
(7, NULL, 2, 1, '500.00', 'On Demand', '', 0, '', '2021-03-25 19:11:33', '2021-03-25 19:11:33'),
(8, NULL, 6, 1, '30000.00', 'On Demand', '', 0, '', '2021-03-25 19:23:37', '2021-03-25 19:23:37');
...
--
-- Dumping data for table `trans_wms_work_items`
--

INSERT INTO `trans_wms_work_items` (`id`, `wms_id`, `item_id`, `description`, `remarks`, `number1`, `number2`, `number3`, `length`, `breadth`, `height`, `unit`, `quantity`, `rate_type_id`, `total_rate`, `total_amount`, `status`, `created_on`, `updated_on`) VALUES
(12, 5, 5, 'test', 'test', '1.00', '1.00', '1.00', '12.00', '12.00', '12.00', 'cum', 800, 1, NULL, NULL, '1', '2021-03-28 18:34:00', '2021-03-28 18:34:00'),
(13, 9, 1, 'Earth work excavation in ordinary soil exclusive of compensation of earth. :Kassi  work  undressed  involving  n  average  horizontal throw upto 2 metres, and an average vertical lift upto 0.05 metre including breaking of clods.', '12', '1212.00', '23.00', '23.00', '23.00', '23.00', '23.00', '32', 23, 1, NULL, NULL, '1', '2021-03-29 04:37:54', '2021-03-29 04:37:54');
...
--
-- Indexes for table `mst_user_roles`
--
...
--
-- AUTO_INCREMENT for table `mst_user_roles`
--
ALTER TABLE `mst_user_roles`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `mst_user_roles`
--
ALTER TABLE `mst_user_roles`
  ADD CONSTRAINT `mst_user_roles_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `mst_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mst_user_roles_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `mst_roles` (`id`);
